...
**Plans**: 4/4 plans executed en 4 waves (tracer-first: el camino entero se demuestra sobre la variante de forma NUEVA del bloque antes de expandir a las 110)
...
- [x] 48-02-PLAN.md — Ejecutar la decisión del autor sobre el doc y cerrar `fare-indicativo` (54), con los ocho tiempos del indicativo distinguidos en español
...
- [x] 48-04-PLAN.md — `fare-indefiniti` (21) y `fare-cond-imperativo` (17): las tres asimetrías entre lenguas traducidas y declaradas; las 122 completas
