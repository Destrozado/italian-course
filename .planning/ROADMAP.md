...
**Plans:** 3 plans
Plans:
- [ ] 09-01-PLAN.md — Schema validator extension (validateValidationShape) + pure helper deriveStatus + smoke test paramétrico VAL-07 tras feature flag
...
| 9. Infraestructura de validación | v1.1 | 0/3 | Plans created | — |
