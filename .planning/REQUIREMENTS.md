...
- [x] **EX-04**: **Emparejar** recrea las píldoras en 2 columnas con **badge numérico** por par y estados activa / emparejada (`green-tint`) + nota "N de M emparejadas". (DESVIACIONES CONSCIENTES: D-03 mantiene el flujo **por-pareja** → sin CTA deshabilitado hasta completar; D-05 omite el estado **candidata (borde discontinuo)** por no encajar en el layout 2-col por-pareja. 33-04.)
