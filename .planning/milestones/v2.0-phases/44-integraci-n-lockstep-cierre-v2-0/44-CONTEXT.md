...
- `.planning/milestones/v1.1-phases/09-infraestructura-de-validaci-n/09-VALIDATION-PROMPT.md` — declarar el 4º magnet y los gates G1-G3 de los cruces si el quórum los necesita para no dar falsos positivos.
...
- `.planning/milestones/v1.1-phases/09-infraestructura-de-validaci-n/09-VALIDATION-PROMPT.md` — criterios C1-C5 y **las excepciones declaradas a R1-R7**. Toda excepción o gate nuevo de esta fase va escrito aquí, no solo en el `notes`.
