...
<!-- Entre milestones — v1.5 cerrado 2026-06-05. El próximo milestone (v1.6) y sus REQ-IDs se definen vía /gsd:new-milestone. -->

_(Sin milestone activo. Candidato inmediato: CONV-01 cont. — convertir las 6 categorías restantes a slots, 1 fase por categoría + migración `8→9`. Ver §Next Milestone Goals y ROADMAP §Backlog.)_
